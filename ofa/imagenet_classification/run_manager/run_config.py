...
from ofa.imagenet_classification.data_providers import ImagenetDataProvider, PracticalDLDataProvider

__all__ = ["RunConfig", "ImagenetRunConfig", "DistributedImageNetRunConfig",
           "PracticalDLRunConfig", "DistributedPracticalDLRunConfig"]
...
class PracticalDLRunConfig(RunConfig):
    def __init__(
        self,
        n_epochs=150,
        init_lr=0.05,
        ...
        **kwargs
        ...
        super(PracticalDLRunConfig, self).__init__(
            n_epochs,
            init_lr,
            lr_schedule_type,
            lr_schedule_param,
    ...
    def data_provider(self):
        if self.__dict__.get("_data_provider", None) is None:
            if self.dataset == PracticalDLDataProvider.name():
                DataProviderClass = PracticalDLDataProvider
            else:
                raise NotImplementedError
            self.__dict__["_data_provider"] = DataProviderClass(
                train_batch_size=self.train_batch_size,
...
class DistributedPracticalDLRunConfig(ImagenetRunConfig):
    def __init__(
        self,
        n_epochs=150,
        init_lr=0.05,
        ...
        **kwargs
        ...
        super(DistributedPracticalDLRunConfig, self).__init__(
            n_epochs,
            init_lr,
            lr_schedule_type,
            lr_schedule_param,
