...
__all__ = ["PracticalDLDataProvider"]


class PracticalDLDataset(torch.utils.data.Dataset):
...
class PracticalDLDataProvider(DataProvider):
    DEFAULT_PATH = "./data/PracticalDL"
    ...
    def save_path(self):
        if self._save_path is None:
            ...
            if not os.path.exists(self._save_path):
                self._save_path = os.path.expanduser("./data/PracticalDL")
    ...
    def train_dataset(self, _transforms):
        return PracticalDLDataset(self.train_path, 
                                 self.save_path,
                                _transforms)

    def test_dataset(self, _transforms):
        return PracticalDLDataset(self.valid_path,
                                 self.save_path,
                                _transforms)
    @property
    def train_path(self):
        return os.path.join(self.save_path, "train.txt")

    @property
    def valid_path(self):
        return os.path.join(self.save_path, "val.txt")
